...
const allProducts: Product[] = [
  { id: 'PA001', name: 'Reversed Dog', category: 'Paintings', price: 1600, quantity: 1 },
  { id: 'PA002', name: 'Krishan Ji!', category: 'Paintings', price: 1200, quantity: 1 },
  { id: 'PA003', name: 'The Beginning', category: 'Paintings', price: 6000, quantity: 1 },
  { id: 'PA009', name: '3D Art Whale', category: 'Paintings', price: 5100, quantity: 1 },
  { id: 'PA013', name: 'Different Circles', category: 'Paintings', price: 6500, quantity: 1 },
  { id: 'MP001', name: 'Just Keep Swimming', category: 'Mini Paintings', price: 300, quantity: 1 },
  { id: 'MP007', name: 'Beleaf', category: 'Mini Paintings', price: 500, quantity: 1 },
  { id: 'MP014', name: 'Black Dots on Rainbow', category: 'Mini Paintings', price: 800, quantity: 1 },
  { id: 'MP017', name: 'Zodiac - Virgo', category: 'Mini Paintings', price: 350, quantity: 1 },
  { id: 'MP023', name: 'One Line Rose', category: 'Mini Paintings', price: 500, quantity: 1 },
  { id: 'TF001', name: 'The Faces We Keep - Men', category: 'Paintings', price: 2500, quantity: 2 },
  { id: 'TF003', name: 'The Faces We Keep - Women', category: 'Paintings', price: 2500, quantity: 15 },
  { id: 'DI001', name: 'Naughty David Diary', category: 'Diaries', price: 390, quantity: 13 },
  { id: 'DI003', name: 'Brown Paper Diary', category: 'Diaries', price: 190, quantity: 22 },
  { id: 'DI004', name: 'Cat Spiral Diary', category: 'Diaries', price: 300, quantity: 6 },
  { id: 'DI012', name: 'Van Gogh Diary', category: 'Diaries', price: 390, quantity: 50 },
  { id: 'DI013', name: 'Frida Kahlo Diary', category: 'Diaries', price: 390, quantity: 50 },
  { id: 'BK001', name: 'Wooden Bookmark', category: 'Bookmarks', price: 80, quantity: 28 },
  { id: 'TB001', name: 'Tote Bag Red', category: 'Tote Bags', price: 300, quantity: 10 },
  { id: 'TB002', name: 'Tote Bag Black', category: 'Tote Bags', price: 210, quantity: 9 },
  { id: 'TB003', name: 'Tote Bag White', category: 'Tote Bags', price: 300, quantity: 8 },
  { id: 'ZA001', name: 'Zen Art Square Red', category: 'Art Prints', price: 1500, quantity: 7 },
  { id: 'ZA002', name: 'Zen Art Square Blue', category: 'Art Prints', price: 1500, quantity: 6 },
  { id: 'CO001', name: 'Coasters Square Set of 3', category: 'Coasters', price: 590, quantity: 2 },
  { id: 'CO002', name: 'Coasters Round Set of 5', category: 'Coasters', price: 950, quantity: 2 },
  { id: 'DC002', name: 'Decoupage Magnets Square', category: 'Decoupage', price: 140, quantity: 5 },
  { id: 'DC003', name: 'Decoupage Magnets Round', category: 'Decoupage', price: 140, quantity: 26 },
  { id: 'PC001', name: 'Pardon Me Postcard', category: 'Postcards', price: 60, quantity: 100 },
  { id: 'PC007', name: 'Shadi Kab Karoge Postcard', category: 'Postcards', price: 60, quantity: 100 },
  { id: 'JW001', name: 'Square Necklace', category: 'Jewellery', price: 600, quantity: 1 },
  { id: 'JW004', name: 'Necklace Earrings Set', category: 'Jewellery', price: 1200, quantity: 2 },
  { id: 'JW007', name: 'Earrings Style 1', category: 'Jewellery', price: 750, quantity: 1 },
];
